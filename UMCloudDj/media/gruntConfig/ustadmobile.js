...
function testContentCallback(arg){
	...
	//	/*
			...
			//Format on table.
			//id|name|result|runtime|dategroup|platform|ustad_version|pub_date|upd_date
			//auto|Planets and Physics|pass|runtime|course|grunt|Course ID: 4|auto|auto

			//Format to be sent:
			//new|Planets and Physics|pass/fail|runtime|grunt|Course ID: |
	//	*/

		}
//	}
    /*testiOwn("Scan through the content all pages.", function(){
        ok(arg == "checkContentPageLoad success", "Scan content pages okay.");
        console.log("TESTING OK 08");
    });*/
}
